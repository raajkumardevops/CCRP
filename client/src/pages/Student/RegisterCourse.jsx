    ...
    <div className="register-container">
      <div className="register-card">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input type="text" name="year" placeholder="Year (Final Year)" value={formData.year} onChange={handleChange} required />
          ...
          <textarea name="skills" placeholder="Your Skills" value={formData.skills} onChange={handleChange} required></textarea>

          <textarea name="interestReason" placeholder="Why are you interested in this course?" value={formData.interestReason} onChange={handleChange} required></textarea>
